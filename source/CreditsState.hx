...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			['Collab'],
			['Douyhe',		        'douyhe',		    'Pizzaroni',				                                    'https://www.youtube.com/channel/UCsRQ6-fOpWTGe5JDLxiCZ1A',	'375ACF'],
			[''],
			['Cameos'],
			['Hipix',               'hipix',			'Hipix',						                                'https://www.youtube.com/channel/UCHuXrDurJALQUPTJ56rW0qw',	'F3F3F3'],
			['Mumbles Binbows P',   'binbows',			'Mumbles',						                                'https://www.youtube.com/channel/UCuUAf0wNgTpRzv5ljADpCow',	'8CBCDB'],
			...
			['Ronathin Ronbon',     'ronathin',			'Ronathin',						                                'https://www.youtube.com/c/R%C3%B8nbonRonathin',	        'FFD400'],
			[''],
			['Psych Engine Team'],
